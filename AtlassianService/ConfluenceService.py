...
class ConfluenceClient:
    ...
    def authenticate(self):
        try:
            ...
            raise Exception(f"Failed to authenticate Confluence client: {str(e)}")
    ...
    def post_confluence_page(self, page_id, page_space, tables):
        ...
        if monthly_page_exists:
            monthly_page = self.confluence.get_page_by_title(title=month_page_name, space=report_space)
